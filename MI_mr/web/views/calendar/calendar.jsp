    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
               ...
               <button class="btn btn-primary" style="background-color: #f4623a;border:#f4623a;" onclick="location.href='<%=request.getContextPath()%>/deleteEvent?eventId='"+$("#getEventId").val()><a id="eventUrl" target="_blank" color="white">Delete</a></button>
                 --%>
            </div>
        </div>
    </div>
